...
namespace DateSystem
{
    class DALDateSystem
    {
        ...
        public DALDateSystem(Conexao conexao)
        {
            objConexao = conexao;
        }
        ...
        public void IncluirCepFisico(CepF cep)
        {
            ...
            */
            cmd.CommandText = "exec D_PessoaCepPrincipalFInserir @IdCep,@Cep,@TipoLogradouro,@Endereco,@Numero,@Complemento,@Bairro,@Cidade,@SiglaCidade;select @@IDENTITY;";
        ...
        public void IncluirCepJuridico(CepJ cep)
        {
            ...
            cmd.CommandText = "exec D_PessoaCepPrincipalJInserir @IdCep,@Cep,@TipoLogradouro,@Endereco,@Numero,@Complemento,@Bairro,@Cidade,@SiglaCidade;select @@IDENTITY;";

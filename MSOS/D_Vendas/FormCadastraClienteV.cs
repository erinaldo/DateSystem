...
namespace DateSystem
{
    public partial class FormCadastraClienteV : Form
    {
        ...
        public FormCadastraClienteV(string NOMESERVIDOR, string NOMEBASEDADOS, string NOMEUSUARIO, string SENHABASEDADOS)
        {
            ...
            label29.Text = " Cadastra novo nome \nde cartão de crédito.";

            label30.Text = "Cadastra como o cliente \nconheceu sua empresa ( mídia )";

            txtFiliacao.MaxLength = 60;
            txPreferenciasComerciais.MaxLength = 60;
            txtReferenciaBancaria.MaxLength = 60;
            txtLimiteCredito.MaxLength = 8;
            txtEmailEletronico.MaxLength = 40;
            txtPaginaWeb.MaxLength = 50;
            comboBoxRetencaoTributos.MaxLength = 60;
            txtNumeroCartao.MaxLength = 16;
            txtNomeImpresso.MaxLength = 60;
            //comboBoxClienteConheceuEmpresa.MaxLength = 60;
        ...
        public void AlteraBotoesDadosAdicionais(int op)
        {
            //Cadastra dados Clientes
            if(op == 1)
            {

            }
            //Cancelar Cadastra dados Clientes
            if (op == 2)
            {

            }
            //Cadastra dados Internet
            if (op == 3)
            {

            }
            //Cancelar Cadastra dados Internet
            if (op == 4)
            {
